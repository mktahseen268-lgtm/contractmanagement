...
│   ├── api/                       # FastAPI backend
│   │   ├── alembic.ini
│   │   ├── migrations/            # Alembic — env.py + versions/0001_initial, 0002_rls, 0003_files, 0004_auth, 0005_workflows, 0006_signatures
│   │   ├── app/
...
│   │   │   ├── tasks.py           # background tasks — OCR/AI pipeline (realistic stub) · contract-PDF render · seal_envelope (executed PDF + certificate)
│   │   │   ├── seed.py            # demo-data seeder
│   │   │   └── routers/           # auth (login/MFA/refresh/sessions/password) · contracts (incl. submit-for-approval / workflow/decide / pdf / versions / prepare-signature) · workflows · signatures (envelopes + the public /sign/{token} portal) · inbox (cross-contract "waiting on you" queue + summary) · dashboard · reports (summary aggregates + contracts CSV) · audit · files · misc (users/notifications/ocr)

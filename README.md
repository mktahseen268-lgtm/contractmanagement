...
- **The block editor** ✅ a first cut (Tiptap, Markdown round-trip, toolbar). TODO: the slash (`/`) menu, dynamic variables / merge fields, clause inserts, inline comments & suggestions (redlines), version-history UI with diff/restore, real-time collaboration (docs/11).

...
const RAIL: RailItem[] = [
  ...
  { href: "/clients", label: "Clients", icon: Contact, match: (p) => p.startsWith("/clients") },
  { href: "/clauses", label: "Clause Library", icon: Library, match: (p) => p.startsWith("/clauses") },
  { href: "/obligations", label: "Obligations", icon: ListTodo, match: (p) => p.startsWith("/obligations") },
  { href: "/redline", label: "Redlines", icon: FileDiff, match: (p) => p.startsWith("/redline") },
  { href: "/ai-analysis", label: "AI Analysis", icon: ScanText, match: (p) => p.startsWith("/ai-analysis") },
  { href: "/docx-studio", label: "Word Studio", icon: FileStack, match: (p) => p.startsWith("/docx-studio") },
  ...
  { href: "/temporary-access", label: "Shared Access", icon: Timer, match: (p) => p.startsWith("/temporary-access") },
  ...
  { href: "/departments", label: "Departments", icon: Building2, match: (p) => p.startsWith("/departments"), adminOnly: true },
  { href: "/roles", label: "Roles", icon: KeyRound, match: (p) => p.startsWith("/roles"), adminOnly: true },
  { href: "/folders", label: "Folders", icon: FolderTree, match: (p) => p.startsWith("/folders"), adminOnly: true },
  { href: "/custom-fields", label: "Custom Fields", icon: Blocks, match: (p) => p.startsWith("/custom-fields"), adminOnly: true },
  ...
  { href: "/legal-hold", label: "Legal Holds", icon: Lock, match: (p) => p.startsWith("/legal-hold"), adminOnly: true },
  { href: "/audit", label: "Audit log", icon: ShieldCheck, match: (p) => p.startsWith("/audit") },
  { href: "/accessibility", label: "Accessibility", icon: Accessibility, match: (p) => p.startsWith("/accessibility") },
  { href: "/integrations", label: "Integrations", icon: Plug, match: (p) => p.startsWith("/integrations"), adminOnly: true },
  { href: "/sso-admin", label: "Single Sign-On", icon: ShieldCheck, match: (p) => p.startsWith("/sso-admin"), adminOnly: true },
